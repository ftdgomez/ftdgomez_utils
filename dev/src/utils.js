 ...
 * }
 */
export const _setArrayToObject = (array, key) => {
  let temp = {};
  Object.assign(
    temp,
    ...array.map((o) => {
 ...
 * @returns Date + Number
 */
export const _daysFromDate = (date, days = 0) => {
 ...
 */
export const _objectHasValue = (obj, properties) => {
  try {
 ...
 */
export const _where = (array, properties) => {
  let response = [];
  array.forEach((el) => {
